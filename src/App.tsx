...
export default function App() {
  ...
  return (
    <div className="min-h-[100dvh] w-full selection:bg-gold/30 relative pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)]">
      <Fairylights />
      ...
      <div
        className={cn(
          "min-h-[100dvh] transition-all duration-1000 relative z-10",
